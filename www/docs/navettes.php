...
<body>
  ...
  <div class="docs-page">
    <div class="intro-section">
      <h1 class="principal-title">Demandes de Navettes</h1>
    ...
    <div class="docs-item">
      <h1>3. De quelle gamme ?</h1>
      <p>Vous devez renseigner de quelle gamme le projet que vous demandez en Navette est. Faites un copier-coller du nom dans SManager 2</p>
