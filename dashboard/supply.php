  ...
  <div id="page">
    ...
    <div class="btn-group multiple-item">
      ...
      <div style="display:inline-flex">
        <button onclick="confirm()" class="link link-suppr ">Effacer </button>
