      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="col-12 mb-3">
            ...
            <hr>
            <ul>
              <li>Test du darkmode pour le Dashboard Vendeurs en A/B testing sur la page.</li>
              <li>Ajout d'une ombre intérieure au menu latéral.</li>
            </ul>
          </div>
          <div class="col-12 mb-3">
            <h3 class="current">
            ...
            <h6>07/08/2022</h6>
            <small>MàJ du Site Principal uniquement.</small>
            <hr>
            <ul>
              <li>Nouvelle disposition de la page d'accueil avec des images revues.</li>
              <li>Passage à Bootstrap 5.2.0 en version Stable.</li>
              <li>Ajustements sur l'état de survol (:hover) des boutons.</li>
            </ul>
          </div>
          <div class="col-12 mb-3">
            <h3 class="current">
            ...
            <h6>30/07/2022</h6>
            <small>MàJ du Dashboard Vendeur uniquement.</small>
            <hr>
            <ul>
